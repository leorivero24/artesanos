...
//         <div class="card-body">
//           <h5 class="card-title">${pub.usuario_nombre}</h5>
//           <p class="card-text">${pub.descripcion}</p>
//           <p class="text-muted small">${new Date(pub.fecha_publicacion).toLocaleString()}</p>
//           <ul class="list-group mb-2">
//             ${pub.comentarios.map(c => `
//               <li class="list-group-item"><strong>${c.usuario_nombre}:</strong> ${c.contenido}</li>
//             `).join('')}
//           </ul>
        ...
        users.forEach(user => {
          ...
          div.innerHTML = `
            <div class="d-flex align-items-center">
              <img src="https://i.pravatar.cc/30?img=${user.id}" class="rounded-circle me-2" style="width: 30px; height: 30px;">
